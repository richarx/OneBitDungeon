...
public class CircleDamageZone : MonoBehaviour
{
    ...
    public void Setup()
    {
        ...
        .Group(Tween.PunchScale(transform, punchStrength, punchDuration, punchFrequency))
        .Chain(Tween.MaterialProperty(spriteRenderer.material, alphaId, 0.0f, despawnDuration));
    }
}
