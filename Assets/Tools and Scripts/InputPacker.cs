...
namespace Tools_and_Scripts
{
    ...
    public class InputPackage
    {
        ...
        public InputData GetTaunt => lastInputType == InputType.Gamepad ? leftArrowButton : leftKey;
        public InputData GetCriticalAttack => lastInputType == InputType.Gamepad ? rightShoulder : tabKey;
        ...
        public InputData GetDialogueConfirm => lastInputType == InputType.Gamepad ? northButton : eKey;
        public InputData GetDialogueQuit => lastInputType == InputType.Gamepad ? eastButton : rKey;
