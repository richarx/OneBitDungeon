            ...
            private static Result GetMixedSplitAxisAndButtonPairs() {
                ...
                for (int thisIndex = 0; thisIndex < count; thisIndex++) {
                    ...
                    if (aem1.elementType == ControllerElementType.Axis && aem1.axisType == AxisType.Split && aem1.axisContribution == Pole.Negative) {
                        if ((aem2 = Find(thisAems, 0, ControllerElementType.Axis, AxisType.Split, Pole.Positive, out thisIndex2, thisUsedAems)) == null) continue; // no matching positive
                        if ((otherAem1 = Find(otherAems, 0, ControllerElementType.Button, AxisType.None, Pole.Negative, out otherAemIndex1, otherUsedAems)) == null) continue;
                        if ((otherAem2 = Find(otherAems, 0, ControllerElementType.Button, AxisType.None, Pole.Positive, out otherAemIndex2, otherUsedAems)) == null) continue;
                        _results.Add(new Pair<ActionElementMapPair>(new ActionElementMapPair(aem1, aem2), new ActionElementMapPair(otherAem1, otherAem2)));
                        thisUsedAems.Array[thisIndex] = true;
                        thisUsedAems.Array[thisIndex2] = true;
                        otherUsedAems.Array[otherAemIndex1] = true;
                        ...
                        if ((aem2 = Find(thisAems, 0, ControllerElementType.Button, AxisType.None, Pole.Positive, out thisIndex2, thisUsedAems)) == null) continue; // no matching positive
                        if ((otherAem1 = Find(otherAems, 0, ControllerElementType.Axis, AxisType.Split, Pole.Negative, out otherAemIndex1, otherUsedAems)) == null) continue;
                        if ((otherAem2 = Find(otherAems, 0, ControllerElementType.Axis, AxisType.Split, Pole.Positive, out otherAemIndex2, otherUsedAems)) == null) continue;
                        _results.Add(new Pair<ActionElementMapPair>(new ActionElementMapPair(aem1, aem2), new ActionElementMapPair(otherAem1, otherAem2)));
                        thisUsedAems.Array[thisIndex] = true;
                        thisUsedAems.Array[thisIndex2] = true;
                        otherUsedAems.Array[otherAemIndex1] = true;
